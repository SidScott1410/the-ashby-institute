...
export const PUBLICATIONS_DATA: Publication[] = [
  {
    ...
    subtitle: "Forecasting by elimination against six constraints, only one of which is physical law.",
    authors: [
    ...
    body: [
      ...
      {
        id: "withdrawn",
        heading: "What This Paper Withdrew",
        content: [
      ...
      },
      {
        ...
        blockquote: "\"The slack ratio: what the binding constraint permits, over what a candidate requires. Below one, and the answer needs a wall to move faster than walls move.\"",
      },
      {
        id: "the-call",
        heading: "The Call",
