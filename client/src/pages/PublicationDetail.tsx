          ...
          {pub.body.map((section) => {
            ...
            if (section.id === "signpost-register") {
              const signposts = [
                ...
                { id: "S14", signpost: "Thermodynamic headroom",   what: "Joules per unit output against the practical CMOS ceiling",              triggers: "Headroom falls below one order of magnitude",                           source: "Published efficiency benchmarks", cadence: "Annual" },
                { id: "S15", signpost: "Talent stock and flow",    what: "Inbound AI researchers to the US",                                       triggers: "Inbound flow recovers above its 2017 level",                           source: "NSF; visa data",          cadence: "Annual" },
                { id: "S16", signpost: "Tier stability",           what: "Whether observed expansion rates preserve the tier ordering",            triggers: "Any tier's rate crosses the tier above it for two consecutive years",  source: "Cross-tier rate tracking", cadence: "Annual" },
                { id: "S17", signpost: "Correlated stress",        what: "Simultaneous movement in two or more Tier 3 sub-constraints",           triggers: "Two sub-constraints tighten in the same quarter",                    source: "Supply chain indices",    cadence: "Quarterly" },
                { id: "S18", signpost: "Absorption",               what: "Realized productivity growth against the electrification precedent",     triggers: "Annual gain exceeds 1.0pp for two consecutive years",                source: "BLS; OECD",              cadence: "Annual" },
                { id: "S19", signpost: "The Elasticity Gap",       what: "Implied elasticity of attributable output to deployed capacity",         triggers: "Alpha stabilizes outside 1.2 to 1.5 for two consecutive years",      source: "Earnings; academic lit", cadence: "Annual" },
                { id: "S20", signpost: "Tier 3 classification of power", what: "New-entry response in capacity auctions",                        triggers: "A market clears with substantial new entry at or below the cap",      source: "PJM; FERC filings",      cadence: "Annual" },
              ];
              return (
                <section key={section.id} id={section.id} style={{ marginBottom: 48 }}>
                  <h2 style={{ fontFamily: FONT, fontSize: "clamp(1.1rem, 2vw, 1.35rem)", fontWeight: 700, color: "#111", margin: "0 0 24px", letterSpacing: "-0.01em", paddingBottom: 12, borderBottom: B }}>
