    ...
    <Layout>
      ...
      <section style={{ borderBottom: B }}>
        <div className="pub-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          <div className="pub-text" style={{ padding: "56px 48px", borderRight: B }}>
            ...
            <a href="https://d36hbw14aib5lz.cloudfront.net/310419663029926944/ji6TxRc3bzmkZeKBk9w454/compute2030-report-v7_f1a77784.pdf" target="_blank" rel="noopener noreferrer"
      ...
      <section style={{ borderBottom: B }}>
        <div className="pub-cta" style={{ display: "flex" }}>
          <a href="https://d36hbw14aib5lz.cloudfront.net/310419663029926944/ji6TxRc3bzmkZeKBk9w454/compute2030-report-v7_f1a77784.pdf" target="_blank" rel="noopener noreferrer" style={{ fontFamily: FONT, fontSize: 9, letterSpacing: "0.14em", color: "#fff", background: "#111", padding: "20px 32px", textDecoration: "none", borderRight: B, transition: "background 0.15s" }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "#2C3E6B"}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "#111"}
          >READ COMPUTE 2030 →</a>
