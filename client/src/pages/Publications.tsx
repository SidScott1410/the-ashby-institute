    ...
    <Layout>
      ...
      <section style={{ borderBottom: B }}>
        <div className="pub-cta" style={{ display: "flex" }}>
          <a href="/manus-storage/compute2030_final_v3_969057f2.pdf" target="_blank" rel="noopener noreferrer" style={{ fontFamily: FONT, fontSize: 9, letterSpacing: "0.14em", color: "#fff", background: "#111", padding: "20px 32px", textDecoration: "none", borderRight: B, transition: "background 0.15s" }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "#2C3E6B"}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "#111"}
          >READ COMPUTE 2030 →</a>
