    ...
    <Layout>
      ...
      <section style={{ borderBottom: B }}>
        <div className="pub-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          <div className="pub-text" style={{ padding: "56px 48px", borderRight: B }}>
            ...
            <p style={{ fontFamily: BODY_FONT, fontSize: 13, color: "#555", lineHeight: 1.85, margin: "0 0 16px", fontWeight: 300 }}>
            ...
            <blockquote style={{ borderLeft: "3px solid #2C3E6B", paddingLeft: 20, margin: "0 0 32px", fontStyle: "italic" }}>
              <p style={{ fontFamily: BODY_FONT, fontSize: 12, color: "#555", lineHeight: 1.75, margin: 0, fontWeight: 300 }}>
          ...
          <div className="pub-text" style={{ padding: "56px 48px" }}>
            ...
            {[
              ...
              <div key={s.n} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: 16, padding: "12px 0", borderBottom: i < 5 ? B : "none" }}>
                ...
                <div>
                  <p style={{ fontFamily: FONT, fontSize: 12, fontWeight: 600, color: "#111", margin: "0 0 4px" }}>{s.title}</p>
                  <p style={{ fontFamily: BODY_FONT, fontSize: 11, color: "#555", margin: 0, fontWeight: 300 }}>{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ borderBottom: B }}>
        <div className="pub-cta" style={{ display: "flex" }}>
          <a href="/manus-storage/compute2030_report_v1_ec1b767c_ce150801.pdf" target="_blank" rel="noopener noreferrer" style={{ fontFamily: FONT, fontSize: 9, letterSpacing: "0.14em", color: "#fff", background: "#111", padding: "20px 32px", textDecoration: "none", borderRight: B, transition: "background 0.15s" }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "#2C3E6B"}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "#111"}
          >READ COMPUTE 2030 →</a>
